...
class TestAuthorVeiwSet(TestCase):
    ...
    def test_edit_admin(self):
        ...
        response = client.put(f'/api/authors/{author.id}/', {'first_name': 'Говард',
                                                             'last_name': 'Лавкрафт',
                                                             'birthday_year': 1880})
...
class TestBookVeiwSet(APITestCase):
    ...
    def test_edit_book_admin(self):
        ...
        response = self.client.put(
            f'/api/books/{book.id}/', {'name': 'Пиковая Дама', 'author': book.author})
